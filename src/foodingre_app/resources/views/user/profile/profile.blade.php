<x-original-layout.format title="{{ $userInfo->nickname }}">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="flex flex-col justify-start m-12">
            ...
            {{-- <div class="flex max-md:justify-center">
                <h2 class="mx-4 pr-4 border-b-2 border-green-600 hover:border-green-700 ease-linear duration-200 text-sm md:text-xl"><a href="{{ route('user.userProfile.index', ['id' => auth()->user()->id]) }}">自分の投稿一覧</a></h2>
                <h2 class="mx-4 pr-4 border-b-2 border-gray-300 hover:border-green-100 ease-linear duration-200 text-sm md:text-xl"><a href="{{ route('user.userProfile.privatePosts', ['id' => auth()->user()->id ]) }}">非公開投稿の一覧</a></h2>
            </div> --}}
            <h2 class="text-xl">自分の投稿一覧</h2>
            @else
