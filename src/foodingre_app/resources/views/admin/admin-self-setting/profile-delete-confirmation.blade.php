<x-admin-original-layout.format title="アカウント削除の最終確認">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="flex max-md:flex-col justify-between max-md:items-center mx-10 mt-10">
            ...
            <div class="flex max-md:flex-col">
                <a href="{{ route('admin.adminProfile.index') }}" class="flex items-center justify-center max-md:mt-10 max-md:mb-5 md:ml-10 h-12 w-48 border border-gray-500 rounded bg-gray-500 text-white hover:border-gray-600 hover:bg-gray-600 ">戻る</a>
                <form method="POST" action="{{ route('admin.adminProfile.delete', ['id' => auth()->user()->id ]) }}">
                    @csrf
                    @method('delete')
